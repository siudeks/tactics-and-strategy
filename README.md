...
Build a Windows installer release (single EXE file, run on Windows host/runner):
```bash
...
The release EXE is a native Windows installer generated by `jpackage` with bundled Java runtime.
